...
<html>
  <head>
    ...
    <title>Tech Resume by Rafaela Diaz</title>
  ...
  <body>
    <div class="wrapper">
      <header>
        ...
        <p>Rafaela Diaz</p>
        <p class="view"><a href="https://github.com/rafadiaz98/TechResume">View the Project on GitHub <small>rafadiaz98/TechResume</small></a></p>
      </header>
      <section>
        <h1>Welcome</h1>

        <p>Hello! My name is Rafaela Diaz and I am a senior Computer Information Systems major. Welcome to my repository where you will find the technical training and certifications that I have acquired through my coursework at the University of Tulsa. Thank you!</p>
